...
//		Product prod = pserv.selectProductById(id);
		...
		case 2:
			...
			Product prod = pserv.selectProductById(id);
			CartItem item=cserv.selectCartItem(prod, c);
			cserv.removeItem(c, item);
			break;
		}
	}
